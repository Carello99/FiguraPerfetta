...
export class QuadratoPage implements AfterViewInit{
  ...
  */
  calcolaPrecisione() {
    ...
    // Calcola il perimetro del quadrato ideale che può contenere il disegno
    const perimetroQuadratoIdeale = this.calcolaPerimetroQuadratoIdeale();
    ...
    this.precisione = Math.min(Math.floor((percorsoCampione / perimetroQuadratoIdeale) * 100), 100);
    this.precisioneCalcolata = true;
